        ...
        <div class="main-wrap">
            <div class="nav-header bg-transparent shadow-none border-0">
                <div class="nav-top w-100">
                    <a href="index.html"
                        ><i
                            class="feather-zap text-success display1-size me-2 ms-0"
                        ></i
                        ><span
                    ...
                    <div
                        href="#"
                        class="header-btn d-none d-lg-block fw-500 text-white font-xsss p-3 ms-auto w100 text-center lh-20 rounded-xl"
            ...
            <div class="row">
                <div
                    ...
                    style="
                        background-image: url(http://127.0.0.1:8000/user/images/login-bg.jpg);
                    "
                ></div>
                <div
                ...
                >
                    <div
                        class="card shadow-none border-0 ms-auto me-auto login-card"
                    >
                        <div class="card-body rounded-0 text-left">
                            <h2
                                class="fw-700 display1-size display2-md-size mb-3"
                            >
                            ...
                            <form @submit.prevent="submit">
                                <div class="form-group icon-input mb-3">
                                    <i
                                        class="font-sm ti-email text-grey-500 pe-0"
                                    ></i>
                                    <input
                                ...
                                <div class="form-group icon-input mb-1">
                                    ...
                                    <i
                                        class="font-sm ti-lock text-grey-500 pe-0"
                                    ></i>
                                </div>
                            ...
                            <div class="col-sm-12 p-0 text-left">
                                ...
                                <h6
                                    class="text-grey-500 font-xsss fw-500 mt-0 mb-0 lh-32"
                                >
                                    Dont have account
                                    <Link
                                        href="/admin/register"
                            ...
                            <div class="col-sm-12 p-0 text-center mt-2">
                                ...
                                <div class="form-group mb-1">
                                    <a
                                        href="/auth/github"
                                        class="form-control text-left style2-input text-light fw-600 bg-facebook bg-dark border-0 p-0 mb-2"
                                        ><img
                                            src="http://127.0.0.1:8000/user/images/icon-1.png"
                                            alt="icon"
        ...
        >
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content border-0">
                    ...
                    <div
                        class="modal-body p-3 d-flex align-items-center bg-none"
                    >
                        <div
                            class="card shadow-none rounded-0 w-100 p-2 pt-3 border-0"
                        >
                            <div class="card-body rounded-0 text-left p-3">
                                <h2
                                    class="fw-700 display1-size display2-md-size mb-4"
                                >
                                    Login into <br />your account
                                </h2>
                                <form>
                        ...
                        >
                            <div class="card-body rounded-0 text-left p-3">
                                ...
                                <form>
                                    <div class="form-group icon-input mb-3">
                                        <i
                                            class="font-sm ti-user text-grey-500 pe-0"
                                        ></i>
                                        <input
                                            type="text"
                                            class="style2-input ps-5 form-control text-grey-900 font-xsss fw-600"
                                ...
                                <div class="col-sm-12 p-0 text-left">
                                    ...
                                    >
                                        ...
                                        <a href="login.html" class="fw-700 ms-1"
                                            >Login</a
                                        >
                                    </h6>
                                </div>
