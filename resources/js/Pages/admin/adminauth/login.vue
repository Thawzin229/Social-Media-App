...
<div class="row">
    <div class="col-xl-5 d-none d-xl-block p-0 vh-100 bg-image-cover bg-no-repeat" style="background-image: url(http://127.0.0.1:8000/user/images/login-bg.jpg);"></div>
            ...
            <div class="card-body rounded-0 text-left">
                ...
                <form @submit.prevent="submit">
                    ...
                    <div class="form-check text-left mb-3">
                        ...
                        <a href="/admin/forgetpasswordpage" class="fw-600 font-xsss text-grey-700 mt-1 float-right">Forgot your Password?</a>
                    </div>
                </form>
                 
                <div class="col-sm-12 p-0 text-left">
                    <div class="form-group mb-1"><div @click="send()" class="form-control text-center style2-input text-white fw-600 bg-dark border-0 p-0 ">Login</div></div>
                    <h6 class="text-grey-500 font-xsss fw-500 mt-0 mb-0 lh-32">Dont have account <Link href="/admin/register" class="fw-700 ms-1">Register</Link></h6>
                </div>
                <div class="col-sm-12 p-0 text-center mt-2">
                    ...
                    <div class="form-group mb-1"><a href="/auth/github" class="form-control text-left style2-input text-light fw-600 bg-facebook bg-dark border-0 p-0 mb-2"><img src="http://127.0.0.1:8000/user/images/icon-1.png" alt="icon" class="ms-2 w40 mb-1 me-5"> Sign in with GitHub</a></div>
                </div>
            </div>
        </div> 
    </div>
...
methods:{
  send()
  {
    this.$inertia.post("/admin/login",this.userdata);
  }
}
}
</script>
