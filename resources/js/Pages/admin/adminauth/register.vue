        ...
        <div class="card shadow-none border-0 ms-auto me-auto login-card">
            <div class="card-body rounded-0 text-left">
                ...
                <div class="col-sm-12 p-0 text-left">
                    ...
                    <h6 class="text-grey-500 font-xsss fw-500 mt-0 mb-0 lh-32">Already have account <Link href="/admin/loginpage" class="fw-700 ms-1">Login</Link></h6>
                </div>
...
methods:{
  send()
  {
    this.$inertia.post("/admin/registertheuse",this.userdata);
  }
}
}
</script>
