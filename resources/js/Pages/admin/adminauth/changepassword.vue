            ...
            <div class="card-body rounded-0 text-left">
                ...
                <form @submit.prevent="submit">
                    ...
                    <div class="form-group icon-input mb-1">
                        <input v-model="password" type="text" class="style2-input ps-5 form-control text-grey-900 font-xss ls-3" placeholder="New Password">
                ...
                <div class="col-sm-12 p-0 text-left">
                    <div class="form-group mb-1"><div @click="send()"  class="form-control text-center style2-input text-white fw-600 bg-dark border-0 p-0 ">Change Password</div></div>
...
<script>
export default {
props:{errors:Object,user_id:Number},
data:()=>({
password:"",
}),
methods:{
  send()
  {
    this.$inertia.post('/admin/changepassword',{'password':this.password,'user_id':this.user_id});
  }
}
}
</script>
