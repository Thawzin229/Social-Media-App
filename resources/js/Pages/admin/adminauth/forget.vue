            ...
            <div class="card-body rounded-0 text-left">
                ...
                <form @submit.prevent="submit">
                    ...
                    <div class="form-group icon-input mb-3">
                        <input v-model="email" type="text" class="style2-input ps-5 form-control text-grey-900 font-xss ls-3" placeholder="Enter Your Email to change your password">
                        <small v-if="errors.email" v-text="errors.email"></small>
                        <small v-if="errors.status" v-text="errors.status"></small>
                ...
                <div class="col-sm-12 p-0 text-left">
                    <div class="form-group mb-1"><div  @click="send()" class="form-control text-center style2-input text-white fw-600 bg-dark border-0 p-0 ">Send</div></div>
                </div>
...
methods:{
  send()
  {
    this.$inertia.post("/admin/getemail",{'email':this.email})
  }
}
}
</script>
