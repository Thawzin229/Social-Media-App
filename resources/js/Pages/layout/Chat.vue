            ...
            <div class="middle-sidebar-right-content bg-white shadow-xss rounded-xxl">
                ...
                <div class="section full pe-3 ps-4 pt-4 position-relative feed-body">
                    ...
                    <ul class="list-group list-group-flush">
                        <li v-for="(item,index) in user_list.data" :key="index" class="bg-transparent list-group-item no-icon pe-0 ps-0 pt-2 pb-2 border-0 d-flex align-items-center">
                            <figure class="avatar float-left mb-0 me-2">
                                <img :src="'http://127.0.0.1:8000/storage/'+item.image" alt="image" class="w35">
                            </figure>
                            <h3 class="fw-700 mb-0 mt-0">
                                <Link :href="'user/profile/'+item.id" class="font-xssss text-grey-600 d-block text-dark model-popup-chat" >{{ item.name }}</Link>
                            </h3>
