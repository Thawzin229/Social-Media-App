        ...
        <div class="nav-header bg-white shadow-xs border-0">
            ...
            <form action="#" class="float-left header-search">
                <div class="form-group mb-0 icon-input">
                    ...
                    <input v-model="search"  type="text" placeholder="Start typing to search.." class="bg-grey border-0 lh-32 pt-2 pb-2 ps-5 pe-3 font-xssss fw-500 rounded-xl w350 theme-dark-bg">
                </div>
            </form>
            <Link href="/" class="p-2 text-center ms-3 menu-icon center-menu-icon"><i class="feather-home font-lg alert-primary btn-round-lg theme-dark-bg text-current "></i></Link>
            <Link href="/story/page" class="p-2 text-center ms-0 menu-icon center-menu-icon"><i class="feather-zap font-lg bg-greylight btn-round-lg theme-dark-bg text-grey-500 "></i></Link>
            ...
            <Link href="/user/list" class="p-2 text-center ms-0 menu-icon center-menu-icon"><i class="feather-user font-lg bg-greylight btn-round-lg theme-dark-bg text-grey-500 "></i></Link>
            ...
            <Link  href="/setting" class="text-dark p-0 ms-3 menu-icon"><img :src="'http://127.0.0.1:8000/storage/'+$page.props.data_user.image" class="w40 mt--1"></Link>
                ...
                <div class="nav-content">
                    <div class="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1 mb-2 mt-2">
                        ...
                        <ul class="mb-1 top-content">
                            ...
                            <li><Link href="/" class="nav-content-bttn open-font" ><i class="feather-tv btn-round-md bg-blue-gradiant me-3"></i><span>Newsfeed</span></Link></li>
                            <li><Link href="default-badge.html" class="nav-content-bttn open-font" ><i class="feather-award btn-round-md bg-red-gradiant me-3"></i><span>Badges</span></Link></li>
                            <li><Link href="/story/page" class="nav-content-bttn open-font" ><i class="feather-globe btn-round-md bg-gold-gradiant me-3"></i><span>Explore Stories</span></Link></li>
                            <li><Link href="/user/list" class="nav-content-bttn open-font" ><i class="feather-zap btn-round-md bg-mini-gradiant me-3"></i><span>Popular Groups</span></Link></li>
                            <li><Link :href="'/user/profile/'+$page.props.data_user.id" class="nav-content-bttn open-font"><i class="feather-user btn-round-md bg-primary-gradiant me-3"></i><span>Author Profile </span></Link></li>                        
                        </ul>
                    </div>
                    ...
                    <div class="nav-wrap bg-white bg-transparent-card rounded-xxl shadow-xss pt-3 pb-1">
                        ...
                        <ul class="mb-1">
                            ...
                            <li><Link class="nav-content-bttn open-font h-auto pt-2 pb-2" href="/logout" method="post">Logout</Link></li>
                        </ul>
                    </div>
                </div>
            </div>
...
export default {
    ...
    watch:{
        search:function(val){
            this.$inertia.get('/',{'search' : val},{preserveState:true,replace:true});
        }
    }
}
</script>
