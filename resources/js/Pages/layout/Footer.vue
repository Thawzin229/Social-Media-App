            ...
            <div class="modal-content border-0 bg-transparent">
                ...
                <div class="modal-body p-0">
                    ...
                    <div class="form-group mt-3 mb-0 p-3 position-absolute bottom-0 z-index-1 w-100">
                        <input @change="uploadimg" type="file" class="form-control style2-input w-100 bg-transparent border-light-md p-3 pe-5 font-xssss fw-500 text-white" value="">               
                        <span @click="Create()" class="feather-send text-white font-md text-white position-absolute" style="bottom: 35px;right:30px;">Send</span>
                    </div>
                </div>
            </div>
        </div>
...
methods:{
    ...
    Create()
    {
        this.$inertia.post('/story/create',{"image":this.image});
    }
}
}
</script>
