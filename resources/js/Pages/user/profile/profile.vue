            ...
            <div class="middle-sidebar-bottom">
                <div class="middle-sidebar-left">
                    <div class="row">
                        <div class="col-lg-12">
                            <div
                                class="card w-100 border-0 p-0 bg-white shadow-xss rounded-xxl"
                            >
                                <div
                                    class="card-body h250 p-0 rounded-xxl overflow-hidden m-3"
                                >
                                    <img
                                        src="http://127.0.0.1:8000/user/images/u-bg.jpg"
                                        alt="image"
                                    />
                                </div>
                                <div class="card-body p-0 position-relative">
                                    ...
                                    >
                                        <img
                                            ...
                                            "
                                            alt="image"
                                            class="float-right p-1 bg-white w-100"
                                        />
                                        <img
                                            style="
                                                width: 100px;
                                            ...
                                            "
                                            v-if="!social.image"
                                            src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRqHBrszBI4e-gxfxQZDiT2xBCHXAPoKMXwyw&s"
                                            alt="image"
                                            class="float-right p-1 bg-white w-100"
                                        />
                                    </figure>
                                    <h4
                                        v-if="social"
                                        class="fw-700 font-sm mt-2 mb-lg-5 mb-4 pl-15"
                                    >
                                        {{ social.name
                                        }}<span
                                            v-if="social"
                                    ...
                                    >
                                        ...
                                        <a
                                            ...
                                            aria-expanded="false"
                                            ><i
                                                class="ti-more font-md tetx-dark"
                                            ></i
                                        ></a>
                                        <div
                                        ...
                                        >
                                            <div class="card-body p-0 d-flex">
                                                ...
                                                ></i>
                                                <h4
                                                    class="fw-600 text-grey-900 font-xssss mt-0 me-0"
                                                >
                                                    Save Link
                                                    <span
                                            ...
                                            >
                                                <i
                                                    class="feather-lock text-grey-500 me-3 font-lg"
                                                ></i>
                                                <h4
                                                    class="fw-600 mb-0 text-grey-900 font-xssss mt-0 me-0"
                                                >
                                                    Unfollow Group
                                                    <span
                                                        class="d-block font-xsssss fw-500 mt-1 lh-3 text-grey-500"
                                ...
                                >
                                    ...
                                    >
                                        <li
                                            class="active list-inline-item me-5"
                                        >
                                            <a
                        ...
                        <div class="col-xl-4 col-xxl-3 col-lg-4 pe-0">
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            ...
                                            >
                                                ...
                                                >
                                                    <span
                                                        class="percent fw-700 font-xsss"
                                                        data-after="%"
                                                        >78</span
                                                    >
                                                </div>
                                        ...
                                        <div class="col-8 ps-1">
                                            <h4
                                                class="font-xsss d-block fw-700 mt-2 mb-0"
                                            >
                                                Advanced Python Sass
                                                <span
                                                    class="float-right mt-2 font-xsssss text-grey-500"
                                                    >87%</span
                                                >
                                            </h4>
                                            <p
                                                class="font-xssss fw-600 text-grey-500 lh-26 mb-0"
                                            >
                                                Designer
                                            </p>
                                        </div>
                            ...
                            >
                                <div class="card-body d-block p-4">
                                    <h4
                                        class="fw-700 mb-3 font-xsss text-grey-900"
                                    >
                                        About
                                    </h4>
                                    <p
                                        class="fw-500 text-grey-500 lh-24 font-xssss mb-0"
                                    >
                                        Lorem ipsum dolor sit amet, consectetur
                                        adipiscing elit. Morbi nulla dolor,
                                        ornare at commodo non, feugiat non nisi.
                                ...
                                <div class="card-body border-top-xs d-flex">
                                    ...
                                    ></i>
                                    <h4
                                        class="fw-700 text-grey-900 font-xssss mt-0"
                                    >
                                        Private
                                        <span
                                ...
                                <div class="card-body d-flex pt-0">
                                    <i
                                        class="feather-eye text-grey-500 me-3 font-lg"
                                    ></i>
                                    <h4
                                        class="fw-700 text-grey-900 font-xssss mt-0"
                                    >
                                ...
                                <div class="card-body d-flex pt-0">
                                    <i
                                        class="feather-map-pin text-grey-500 me-3 font-lg"
                                    ></i>
                                    <h4
                                ...
                                <div class="card-body d-flex pt-0">
                                    <i
                                        class="feather-users text-grey-500 me-3 font-lg"
                                    ></i>
                                    <h4
                                        class="fw-700 text-grey-900 font-xssss mt-1"
                                    >
                            ...
                            >
                                <div
                                    class="card-body d-flex align-items-center p-4"
                                >
                                    <h4
                                ...
                                <div class="card-body d-block w-100 pt-0">
                                    <a
                                        ...
                                        ><i
                                            class="feather-external-link font-xss me-2"
                                        ></i>
                                        More</a
                                    >
                                </div>
                            ...
                            >
                                ...
                                >
                                    <div
                                        class="bg-success me-2 p-3 rounded-xxl"
                                    >
                                        <h4
                                            class="fw-700 font-lg ls-3 lh-1 text-white mb-0"
                                        >
                                            <span
                                                class="ls-1 d-block font-xsss text-white fw-600"
                                                >FEB</span
                                            >22
                                        </h4>
                                    </div>
                                    ...
                                    >
                                        ...
                                        <span
                                            ...
                                            >41 madison ave, floor 24 new work,
                                            NY 10010</span
                                        >
                                    </h4>
                                </div>
                                ...
                                >
                                    <div
                                        class="bg-warning me-2 p-3 rounded-xxl"
                                    >
                                        <h4
                                            class="fw-700 font-lg ls-3 lh-1 text-white mb-0"
                                        >
                                ...
                                >
                                    <div
                                        class="bg-primary me-2 p-3 rounded-xxl"
                                    >
                                        <h4
                                            class="fw-700 font-lg ls-3 lh-1 text-white mb-0"
                                        >
                        ...
                        <div class="col-xl-8 col-xxl-9 col-lg-8">
                            ...
                            >
                                ...
                                <div class="card-body d-flex p-0 mt-3">
                                    <div
                                        @click="like(post.id, post.user_id)"
                                    ...
                                    <Link
                                        ...
                                        ></i
                                        ><span
                                            v-for="(com, index) in comment"
                                            :key="index"
                                            ><strong
                                                class="me-1"
                                                v-if="com.post_id == post.id"
                                                >{{ com.count }}</strong
                                            ></span
                                        >
                                        Comment</Link
...
export default {
    ...
    methods: {
        ...
        like(id, post_user_id) {
            this.$inertia.post("/like", {
                post_id: id,
                user_id: this.$page.props.data_user.id,
