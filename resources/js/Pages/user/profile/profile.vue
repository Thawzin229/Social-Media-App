                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card w-100 border-0 p-0 bg-white shadow-xss rounded-xxl">
                                <div class="card-body h250 p-0 rounded-xxl overflow-hidden m-3"><img src="http://127.0.0.1:8000/user/images/u-bg.jpg" alt="image"></div>
                                <div class="card-body p-0 position-relative">
                                    <figure class="avatar position-absolute w100 z-index-1" style="top:-40px; left: 30px;"><img style="width: 100px;height: 100px;border-radius: 100%;" :src="'http://127.0.0.1:8000/storage/'+social.user_image" alt="image" class="float-right p-1 bg-white w-100"></figure>
                                    <h4 class="fw-700 font-sm mt-2 mb-lg-5 mb-4 pl-15">{{ social.user_name }}<span class="fw-500 font-xssss text-grey-500 mt-1 mb-3 d-block">{{ social.user_email }}</span></h4>
                        ...
                        <div class="col-xl-4 col-xxl-3 col-lg-4 pe-0">
                            ...
                            <div class="card w-100 shadow-xss rounded-xxl border-0 mb-3">
                                ...
                                <div class="card-body d-block pt-0 pb-2">
                                    <div class="row">
                                        <div v-for="(post,index) in post.data" :key="index" class="col-6 mb-2 pe-1"><a href="" data-lightbox="roadtrip"><img  v-if="post.image" :src="'http://127.0.0.1:8000/storage/'+post.image" alt="image" class="img-fluid rounded-3 w-100"></a></div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-8 col-xxl-9 col-lg-8">
                            ...
                            <div class="card w-100 shadow-xss rounded-xxl border-0 ps-4 pt-4 pe-4 pb-3 mb-3 mt-3">
                                ...
                                <div class="card-body d-flex p-0 mt-0">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end p-4 rounded-xxl border-0 shadow-lg" aria-labelledby="dropdownMenu8">
                                        ...
                                        <div class="card-body p-0 d-flex mt-2">
                                            <i class="feather-alert-circle text-grey-500 me-3 font-lg"></i>
                                            <h4 class="fw-600 text-grey-900 font-xssss mt-0 me-4"><span class="d-block font-xsssss fw-500 mt-1 lh-3 text-grey-500">Save to your saved items</span></h4>
                                        </div>
                                        <div class="card-body p-0 d-flex mt-2">
                                            <i class="feather-alert-octagon text-grey-500 me-3 font-lg"></i>
                            ...
                            <div v-for="(post,index) in post.data" :key="index" class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
                                <div class="card-body p-0 d-flex">
                                    <figure class="avatar me-3"><img style="width: 40px;height: 40px;border-radius: 100%;" :src="'http://127.0.0.1:8000/storage/'+post.user_image" alt="image" class="shadow-sm"></figure>
                                    <h4 class="fw-700 text-grey-900 font-xssss mt-1">{{ post.user_name }} <span class="d-block font-xssss fw-500 mt-1 lh-3 text-grey-500">3 hour ago</span></h4>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end p-4 rounded-xxl border-0 shadow-lg" aria-labelledby="dropdownMenu7">
                                        ...
                                        <div v-if="post.user_id==$page.props.data_user.id" class="card-body p-0 d-flex mt-2">
                                            <i class="feather-alert-octagon text-grey-500 me-3 font-lg"></i>
                                            <h4 class="fw-600 text-grey-900 font-xssss mt-0 me-4"><Link :href="'/user/profile/delete/'+post.id">Delete Post</Link><span class="d-block font-xsssss fw-500 mt-1 lh-3 text-grey-500">Save to your saved items</span></h4>
                                        </div>
                                        <div class="card-body p-0 d-flex mt-2">
                                            <i class="feather-lock text-grey-500 me-3 font-lg"></i>
                                            <h4 class="fw-600 mb-0 text-grey-900 font-xssss mt-0 me-4">Unfollow Group <span class="d-block font-xsssss fw-500 mt-1 lh-3 text-grey-500">Save to your saved items</span></h4>
                                ...
                                <div class="card-body d-block p-0">
                                    <div class="row ps-2 pe-2">
                                        <div v-if="post.image" class="col-lg-12 col-sm-4 p-1"><a href="images/t-10.jpg" data-lightbox="roadtrip"><img :src="'http://127.0.0.1:8000/storage/'+post.image" class="rounded-3 w-100" alt="image"></a></div>
                                    </div>
                                </div>
                                <div class="card-body d-flex p-0 mt-3">
                                    <div @click="like(post.id,post.user_id)" class="d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss me-3"><i class="feather-thumbs-up text-white bg-primary-gradiant me-1 btn-round-xs font-xss"></i> <i class="feather-heart text-white bg-red-gradiant me-2 btn-round-xs font-xss"></i><span v-for="(like,index) in likes" :key="index"><strong class="me-1" v-if="like.post_id==post.id">{{ like.count }}</strong></span> Like</div>
                                    <Link :href="'/comment/'+post.id" class="d-flex align-items-center fw-600 text-grey-900 text-dark lh-26 font-xssss"><i class="feather-message-circle text-dark text-grey-900 btn-round-sm font-lg"></i><span v-for="(com,index) in comment" :key="index"><strong class="me-1" v-if="com.post_id==post.id">{{ com.count }}</strong></span> Comment</Link>
...
export default {
props:{post:Object,social:Array,user_list:Object,likes:Array,comment:Array},
