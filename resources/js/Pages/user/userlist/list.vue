                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            ...
                            <div class="row ps-2 pe-1">
                                ...
                                <div v-for="(user,index) in user_list.data" :key="index" class="col-md-6 col-sm-6 pe-2 ps-2">
                                    <div class="card d-block border-0 shadow-xss rounded-3 overflow-hidden mb-3">
                                        ...
                                        <div class="card-body d-block w-100 pl-10 pe-4 pb-4 pt-0 text-left position-relative">
                                            <figure class="avatar position-absolute w75 z-index-1" style="top:-40px; left: 15px;"><img :src="'http://127.0.0.1:8000/storage/'+user.image" style="width: 70px;height: 70px;border-radius: 100%;" alt="image" class="float-right p-1 bg-white "></figure>
                                ...
                                <Component class="btn btn-secondary mx-1 " :is="link.url?'Link':'span'" :href="link.url" v-html="link.label"  v-for="(link,index) in user_list.links" :key="index"></Component>
                                </div>               
                    </div>
                </div>
...
watch:{
  search:debounce(function(val){
    this.$inertia.get('/user/list',{'search':val},{preserveState:true,replace:true});
  },600)
}
}
</script>
