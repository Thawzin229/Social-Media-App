                        ...
                        <div class="card w-100 border-0 bg-white shadow-xs p-0 mb-4">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-4 text-center">
                                    <figure class="avatar ms-auto me-auto mb-0 mt-2 w100"><img :src="'http://127.0.0.1:8000/storage/'+data_user.image" alt="image" class="shadow-sm rounded-3 w-100"></figure>
                                    <h4 class="text-grey-500 fw-500 mb-3 font-xsss my-4">{{ data_user.name }}</h4>    
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text"  class="form-control" v-model="data_user.name">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" v-model="data_user.email">
                                    ...
                                    <div class="col-lg-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" v-model="data_user.gender">
