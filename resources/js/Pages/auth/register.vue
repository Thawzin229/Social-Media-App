...
<div class="row">
    <div class="col-xl-5 d-none d-xl-block p-0 vh-100 bg-image-cover bg-no-repeat" style="background-image: url(http://127.0.0.1:8000/user/images/login-bg-2.jpg);"></div>
            ...
            <div class="card-body rounded-0 text-left">
                ...
                <form @submit.prevent="submit">
                    ...
                    <div class="form-group icon-input mb-3">
                        ...
                        <input v-model="userdata.name" type="text" class="style2-input ps-5 form-control text-grey-900 font-xsss fw-600" placeholder="Your Name">                        
                        <small class="text-danger" v-if="errors.name" v-text="errors.name" ></small>
                    </div>
                    <div class="form-group icon-input mb-3">
                        <i class="font-sm ti-email text-grey-500 pe-0"></i>
                        <input v-model="userdata.email" type="text" class="style2-input ps-5 form-control text-grey-900 font-xsss fw-600" placeholder="Your Email Address">                        
                        <small class="text-danger" v-if="errors.email" v-text="errors.email" ></small>

                    </div>
                    <div class="form-group icon-input mb-3">
                        <i class="font-sm ti-user text-grey-500 pe-0"></i>
                        <select  v-model="userdata.gender" type="text" class="style2-input ps-5 form-control text-grey-900 font-xsss fw-600" name="" id="">
                          <option value="">Select</option>
                          <option value="male">male</option>
                          <option value="female">female</option>
                        </select>                        
                        <small class="text-danger" v-if="errors.gender" v-text="errors.gender" ></small>

                    </div>
                    <div class="form-group icon-input mb-3">
                        <input v-model="userdata.password" type="Password" class="style2-input ps-5 form-control text-grey-900 font-xss ls-3" placeholder="Password">
                        <i class="font-sm ti-lock text-grey-500 pe-0"></i>
                        <small class="text-danger" v-if="errors.password" v-text="errors.password" ></small>
                ...
                <div class="col-sm-12 p-0 text-left">
                    <div  class="form-group mb-1"><div @click="send()" class="form-control text-center style2-input text-white fw-600 bg-dark border-0 p-0 ">Register</div></div>
                    <h6 class="text-grey-500 font-xsss fw-500 mt-0 mb-0 lh-32">Already have account <Link href="/loginpage" class="fw-700 ms-1">Login</Link></h6>
                </div>
            ...
            <div class="card shadow-none rounded-0 w-100 p-2 pt-3 border-0">
                <div class="card-body rounded-0 text-left p-3">
                    ...
                    <form>
                        ...
                        <div class="form-group icon-input mb-1">
                            <input v-model="userdata.comfirmpassword"  type="Password" class="style2-input ps-5 form-control text-grey-900 font-xss ls-3" placeholder="Confirm Password">
                            <i class="font-sm ti-lock text-grey-500 pe-0"></i>
                        </div>
                        <div class="form-check text-left mb-3">
...
export default {
  props:{errors:Object},
data:()=>({
userdata:{name:"",email:"",password:"",comfirmpassword:"",gender:""}
}),
methods:{
  send()
  {
    this.$inertia.post("/registetheuser",this.userdata);
  }
}
}
</script>
