                    ...
                    >
                        <div class="card-body rounded-0 text-left">
                            ...
                            <div class="col-sm-12 p-0 text-left">
                                ...
                                >
                                    Dont have account
                                    <Link href="/register" class="fw-700 ms-1"
                                        >Register</Link
                                    >
                                </h6>
                            </div>
                            <div class="col-sm-12 p-0 text-center mt-2">
                                <h6
                                    class="mb-0 d-inline-block bg-white fw-500 font-xsss text-grey-500"
                                >
                                ...
                                <div class="form-group mb-1">
                                    <a
                                        href="/auth/google"
                                        class="form-control bg-warning text-left style2-input text-white fw-600 bg-facebook border-0 p-0 mb-2"
                                    >
                                        <div>
                                            <img
                                                src="http://127.0.0.1:8000/user/images/icon-1.png"
                                                alt="icon"
                                                class="ms-2 w40 me-5 text-center"
                                            />
                                        </div>
