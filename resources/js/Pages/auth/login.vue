            ...
            <div class="card-body rounded-0 text-left">
                ...
                <form @submit.prevent="submit">
                    ...
                    <div class="form-check text-left mb-3">
                        ...
                        <a href="/forgetpassword" class="fw-600 font-xsss text-grey-700 mt-1 float-right">Forgot your Password?</a>
                    </div>
                </form>
                ...
                <div class="col-sm-12 p-0 text-left">
                    ...
                    <h6 class="text-grey-500 font-xsss fw-500 mt-0 mb-0 lh-32">Dont have account <Link href="/register" class="fw-700 ms-1">Register</Link></h6>
                </div>
                <div class="col-sm-12 p-0 text-center mt-2">
                    ...
                    <div class="form-group mb-1"><a href="/auth/google" class="form-control bg-warning text-left style2-input text-white fw-600 bg-facebook border-0 p-0 mb-2"><img  src="http://127.0.0.1:8000/user/images/icon-1.png" alt="icon" class="ms-2 w40 mt-4 me-5"> Sign in with Google</a></div>
                </div>
            </div>
        </div> 
    </div>
...
methods:{
  send()
  {
    this.$inertia.post("/login",this.userdata);
  }
}
}
</script>
